...
<body>
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0  bg-dark">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    <a href="/" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                        <span class="fs-5 d-none d-sm-inline mt-3"><h4><b>Hi, {{Auth::user()->name}}</b>
                        </h4>
                        </span>
                    </a>
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start topnav " id="menu">
                        ...
                        <li>
                            <a href="{{ route('list-marks') }}" class="nav-link px-0 align-middle">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-badge-sd text-light" viewBox="0 0 16 16">
                                  ...
                                  </svg> <span class="ms-1 d-none d-sm-inline"><b>Exams</b></span> </a>

                        </li>
                        <li>
                            <a href="{{route('notifications')}}" class="nav-link px-0 align-middle">
                        ...
                        <li>
                            <a href="{{route('firstassignmentlist')}}" class="nav-link px-0 align-middle ">
                        ...
                        <li>
                            <a href="{{ route('list-attendance') }}"  class="nav-link px-0 align-middle ">
                        ...
                        <li>
                            <a href="#submenu2" data-bs-toggle="collapse" class="nav-link px-0 align-middle ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-qr-code text-light" viewBox="0 0 16 16">
                                  ...
                                  </svg><span class="ms-1 d-none d-sm-inline"><b>Generate QR</b></span></a>
            ...
            <div class="col py-3">
                @yield('firstassignmentlist')
                @yield('listassignment')
                @yield('notification')
                @yield('listmarkfirst')
                @yield('listmark')
                @yield('listattendacefirst')
                @yield('listattendance')
                @yield('index')
                <p></p>
