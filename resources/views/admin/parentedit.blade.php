            ...
            <div class="card-body">
                ...
                <form class="mt-2"action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="role" value="{{$parent->role}}" class="form-control " disabled>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="mt-3">Student Reg.No</label>
                      <input type="text" name="regno" value="{{$parent->regno}}" class="form-control">
                    </div>
